...
import { exportRosterActualsCsv, exportRosterGridXlsx, generateRosterMonth } from "@/lib/rosterClient";
...
// file directly (text/csv, or the .xlsx's own binary content type), so this builds the download
// itself via a Blob + a throwaway <a> rather than navigating to the URL (a manager stays on the
// grid, not bounced to a raw file in a new tab).
