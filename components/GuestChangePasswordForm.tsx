...
// Mirrors components/admin/ChangePasswordForm.tsx exactly, pointed at the guest-account route.
export default function GuestChangePasswordForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch("/api/guest-session/change-password", {
      method: "POST",
      credentials: "include",
